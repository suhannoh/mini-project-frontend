    ...
    <div className="page-enter">
      <Layout>
        <main style={{
          ...
          <section>
            {link &&
              <svg viewBox="0 0 24 24" width="80%" height="80%" className="profile-img">
                <g fill="currentColor">
            ...
            <ul className='flex-link-box'>
              ...
              {link.gitHubUrl ?
                <li className='link-box'
                  onMouseEnter={() => { setHover("github"); setUrl(link.gitHubUrl); }}
                  onMouseLeave={() => { setHover(null); setUrl(null); }}>
              ...
              {link.notionUrl ?
                <li className='link-box'
                  onMouseEnter={() => { setHover("notion"); setUrl(link.notionUrl); }}
                  onMouseLeave={() => { setHover(null); setUrl(null); }}>
